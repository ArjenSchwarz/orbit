...
- [x] 4. Copilot workspace.yaml metadata can be parsed
...
- [x] 5. Copilot sessions appear in apsis -l listings
...
- [x] 6. Copilot session UUIDs resolve to transcript files
...
- [x] 7. Session discovery verified end-to-end
