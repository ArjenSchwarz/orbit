...
- [ ] 1. Render agent info in finalize preamble <!-- id:pghg6mg -->
...
- [ ] 2. Verify agent info display behaviour with table-driven tests <!-- id:pghg6mh -->
...
- [ ] 3. Verify chosen variant against consolidation log <!-- id:pghg6mi -->
...
- [ ] 4. Verify mismatch warning behaviour with table-driven tests <!-- id:pghg6mj -->
...
- [ ] 5. Lint and full package test suite pass <!-- id:pghg6mk -->
